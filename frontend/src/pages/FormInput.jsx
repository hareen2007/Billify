...
import Table from './ItemsTable.jsx'
   ...
   const [items, setItems] = useState([
    ...
    <div className="main1">
        ...
        onChange={handleChange}/>
            ...
            <div className='field'>
                <label htmlFor="recp_name">Recipient Name</label>
                <input type="text" name="recp_name" id="recp_name" required placeholder="Enter customer name"  value={formData.recp_name}
        onChange={handleChange}/>
            </div>
            <div className='field full-width'>
                <label htmlFor="recp_address">Recipient Address</label>
                <input type="text" name="recp_address" id="recp_address" required placeholder="Enter customer address"  value={formData.recp_address}
        onChange={handleChange}/>
            </div>
            <div>
                <label htmlFor="recp_no">Recipient no:</label>
        ...
        onChange={handleChange} />
            ...
            <div>
                ...
                <input type="text" name="employee" id="employee" placeholder="Enter your name along with employee id"  value={formData.employee}
        onChange={handleChange}/>
            </div>
            <div>
